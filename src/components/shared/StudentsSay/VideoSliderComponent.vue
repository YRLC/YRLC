<template>
  <div id="carousel-example-generic231" class="carousel slide" data-ride="carousel">
        ...
        <div class="row">
          <div class="col-sm-8 col-sm-offset-2">
            <iframe
              width="560"
              height="315"
              src="https://youtube.com/embed/f8kk7IzzE6s"
              frameborder="0"
              gesture="media"
        ...
        <div class="row">
          <div class="col-sm-8 col-sm-offset-2">
            <iframe
              width="560"
              height="315"
              src="https://youtube.com/embed/b1c6-0F3cSY"
              frameborder="0"
              gesture="media"
              allow="encrypted-media"
              allowfullscreen></iframe>
        ...
        <div class="row">
          <div class="col-sm-8 col-sm-offset-2">
            <iframe
              width="560"
              height="315"
              src="https://youtube.com/embed/76avuE8p3dY"
              frameborder="0"
              gesture="media"
              allow="encrypted-media"
              allowfullscreen></iframe>
        ...
        <div class="row">
          <div class="col-sm-8 col-sm-offset-2">
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/dK77FTXOZ4k"
              frameborder="0"
              gesture="media"
              allow="encrypted-media"
              allowfullscreen></iframe>
        ...
        <div class="row">
          <div class="col-sm-8 col-sm-offset-2">
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/CfmSpfgBrmc"
              frameborder="0"
              gesture="media"
              allow="encrypted-media"
              allowfullscreen></iframe>
    ...
    <ol class="carousel-indicators">
      ...
      <li data-target="#carousel-example-generic231" data-slide-to="4"></li>
      <li data-target="#carousel-example-generic231" data-slide-to="5"></li>
    </ol>
  </div>
</template>
